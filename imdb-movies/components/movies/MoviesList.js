    ...
    return (
      <div>
          ...
          <div className="relative inline-flex">
              ...
              <select onChange={e => this.setState({select: {menu: 'director', value: e.target.value}})}
              ...
              <div className="relative inline-flex">
                  ...
                  <select onChange={e => this.setState({select:{menu: 'genres', value: e.target.value}})}
                      className="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
              ...
              <div className="relative inline-flex">
                  ...
                  <select
                      className="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none" onChange={e => this.setState({select:{menu: 'year', value: e.target.value}})
                  }>
