const CommentCard = (props) => {
    ...
    <div className="ml-4 max-w-5xl relative">
        <div  className="border-2 border-blue-200 bg-blue-50 rounded-lg p-3  flex flex-col justify-center items-center md:items-start shadow-inner mb-4">
            ...
            <svg onClick={e => prompt("Change your comment here")} className="w-8 h-8 hover:text-indigo-500 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
            </svg>
            <svg className="w-8 h-8 hover:text-indigo-500 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
